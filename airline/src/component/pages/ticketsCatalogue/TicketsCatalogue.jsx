          ...
          <div className="flex items-center justify-center h-full">
            <div className="w-full bg-gradient-to-br from-purple-200 to-pink-200 rounded overflow-hidden shadow-lg border border-gray-300">
                ...
                <div className="flex items-center mb-4 sm:mb-0">
                  ...
                  <div>
                    <p className="text-lg font-bold text-slate-950">
                      {ticket.from} {t('to')} {ticket.destination}
                    </p>
                    <p className="text-sm text-gray-600">
                      {t('Flight:')} {ticket.flightNum}
                    </p>
                  </div>
                </div>
                <div>
                  <p className="text-sm text-gray-600">
                    {t('Available Seats:')} {ticket.Availableseats}
                  </p>
                </div>
              </div>
              ...
              <div className="p-4">
                ...
                <p className="text-sm text-gray-600">
                  {t('Departure:')} {ticket.departureDate}
                </p>
                <p className="text-sm text-gray-600">
                  {t('Arrival:')} {ticket.arrivalDate}
                </p>
                <p className="text-sm text-gray-600">
